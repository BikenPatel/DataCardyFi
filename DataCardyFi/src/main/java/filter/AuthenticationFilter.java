...
public class AuthenticationFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            // Your authentication logicS   
            if ((url.contains("registration.xhtml") || url.contains("dashboard.xhtml") || url.contains("manualform.xhtml") || url.contains("checkform.xhtml")) && sessionBean.getSessionAttribute("UserID") == null) {
